 ...
 */
package tony.cliente.util;



import tony.cliente.App;
import tony.cliente.controller.Controller;
...
public class FlowController {
    ...
    public void goMain() {
        try {
            this.mainStage.setScene(new Scene(FXMLLoader.load(App.class.getResource("view/reproductorView.fxml"), this.idioma)));
            this.mainStage.show();
